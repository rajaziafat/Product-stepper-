...
const Modal = ({ onClose }) => {
  ...
  const totalSteps = 4; // Adjusted to match the total number of steps
  ...
  return (
    <div className="absolute top-12 md:top-0 bottom-0  left-0 right-0 flex items-center justify-center bg-transparent bg-opacity-80 px-4">
      <div className="bg-[#2d2d2d] border-gray-600 w-full max-w-[900px] h-[650px] md:h-[700px] p-4 rounded-xl shadow-lg flex flex-col overflow-x-auto">
    ...
    <>
      <div className='grid grid-cols-12 gap-4 mt-5 items-center '>
        <div className='col-span-12 md:col-span-6 w-full'>
          ...
          <div className='py-2 px-2 relative mt-2 '>
            <label className="block text-sm text-white absolute top-1 z-10 -mt-2 ml-2 bg-[#2d2d2d] px-1">Short Desc</label>
